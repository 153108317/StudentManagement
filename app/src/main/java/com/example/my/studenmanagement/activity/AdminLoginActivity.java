    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LayoutInflater factory = LayoutInflater.from(AdminLoginActivity.this);
                        ...
                        if (codeInfo.equals("10086")) {
                            ...
                            if (firstPasswordInfo.matches("[0-9]{6}")) {
                                ...
                                if (firstPasswordInfo.equals(secondPasswordInfo)) {
                                    ...
                                    //用户是否存在
                                    if (cursor.moveToNext()) {
                                        Toast.makeText(AdminLoginActivity.this, "该用户已存在", Toast.LENGTH_SHORT).show();
                                    } else {
                                        db.execSQL("insert into admin(name,password)values(?,?)", new String[]{nameInfo, firstPasswordInfo});
                                    }
                                } else {
                                    Toast.makeText(AdminLoginActivity.this, "两次密码不相同", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(AdminLoginActivity.this, "密码为6位纯数字", Toast.LENGTH_SHORT).show();
                            }


                        } else {
                            Toast.makeText(AdminLoginActivity.this, "注册码错误", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
