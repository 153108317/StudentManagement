                ...
                if (!TextUtils.isEmpty(studentId) && !TextUtils.isEmpty(studentPassword)) {
                    ...
                    if (cursor.moveToNext()) {
                        ...
                        if (password.equals(studentPassword)) {
                            ...
                            Toast.makeText(StudentLoginActivity.this, "密码错误请重新输入", Toast.LENGTH_SHORT).show();
                        }

                    } else {
                        Toast.makeText(StudentLoginActivity.this, "该学号未注册，请联系班主任", Toast.LENGTH_SHORT).show();
                    }


                } else {
                    Toast.makeText(StudentLoginActivity.this, "帐户，密码不能为空", Toast.LENGTH_SHORT).show();
                }
            }
        });
