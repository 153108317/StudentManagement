 ...
 *
 */
public class TecherAdapter extends ArrayAdapter<Techer> {
    private int resourceId;

    public TecherAdapter(Context context, int resource, List<Techer> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Techer techer = getItem(position);
        View view;
        ...
        viewHolder.student_name.setText(techer.name);
        viewHolder.student_id.setText(""+techer.number);
//        String sex = techer.getSex();
//        if (sex.equals("男")) {
