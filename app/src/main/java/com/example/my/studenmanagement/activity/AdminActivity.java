...
public class AdminActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.admin_techer_select).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminActivity.this, TecherInfoActivity.class);
                startActivity(intent);
            }
        });
        findViewById(R.id.admin_techer_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminActivity.this, AddTecherActivity.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminActivity.this, AddStudentInfoActivity.class);
                intent.putExtra("haveData","false");
                startActivity(intent);
            }
        });
        ...
        order.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(AdminActivity.this, StudentTotalScore.class);
                startActivity(intent);
            }
        });
